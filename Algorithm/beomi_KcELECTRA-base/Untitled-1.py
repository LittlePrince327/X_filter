...
말을 잘하는 것은 다르다.
6. 착한 일을 하는 사람에게는 하늘이

복을 주시고, 악한 일을 하는 사람에게는

하늘이 재앙을 주느니라. [공자:명심보감]
7. 탐욕은 일체를 얻고자 욕심내어서

도리어 모든 것을 잃어버린다. [몽테뉴]
8. 백 권의 책에 쓰인 말보다, 한 가지 성실한

마음이 더 크게 사람을 움직인다. [프랭클린]
9. 가장 높은 곳에 올라가려면 가장 낮은 곳부터
...
않는다는 것을 잊지 말라. [단테]
31. 남자는 야생동물이면 여자는 이 야생동물을

길들이는 자이다. – 폴리스 바이언
32. 남자는 언제나 여인의 첫사랑이 되고

싶어한다. 여자는 남자의 마지막 낭만이

되려고 한다. – ?
33. 남자란, 말하며 접근할 때는 봄이지만

결혼해 버리면 겨울이다. – 셰익스피어
34. 죄는 미워하고, 죄수는 사랑하라.

– Mohandas k. Gandhi
35. 나는 한 가지 책임만 아는데, 그것은

사랑하는 것이다.

– Albert Camus (프랑스작가)
36. 사랑의 고통은 다른 어떠한 즐거움보다 달콤하다.

– John Dryden (영국의 시인,극작가)
37. 사랑은 여자의 섬세함을 줄이고, 남자의

섬세함을 늘인다.  – 장 파울(리히터) <티탄>
38. 사랑하면서 바보가 되지 않는 사람은, 결코

사랑하면서  현명해 질 수 없다.

– T. 라이크 <사랑과 육욕>
39. 사랑은, 배우지 않은 사람에게 문학을 가르친다.

– 에우리피데스 <스테네비우스>
40. 사랑은 나이들어 생기 없는 사람들을 젊게
...
겁낸다. [하운드]
43. 만약 제군이 돈의 가치를 알고 싶으면

나가서 얼마간의 돈을 빌려 보라. [프랭클린]
44. 모든 날 중 가장 완전히 잃어버린

날은 웃지 않는 날이다. [샹포르]
45. 물고기를 주어라. 한 끼를 먹을 것이다.

물고기 잡는 법을 가르쳐 주어라.

평생을 먹을 것이다. [탈무드]
46. 할 수 있는 한 훌륭한 인생을 만들라.

인생은 짧고 곧 지나간다. [오울디즈]
47. 열의없이 성취된 위업이란

아직 하나도 없다. [애머슨]
48. 버들가지는 약하나 다른 재목을 묶는다.

[하버트]
49. 오늘 달걀을 한 개 갖는 것보다
...
그것이 나의 길이다. [나폴레옹]
57. 일이 재미있으면 인생은 낙원이다.

일이 의무라면 인생은 지옥이다. [고리끼]
58. 금전은 비료와 같은 것으로

뿌리지 않으면 쓸모가 없다. [베이컨]
59. 사람은 자기가 한 약속을 지킬만한

좋은 기억력을 가져야 한다. [니체]
60. 내일에 아무런 도움이 되지 않는다면,

당신의 과거는 쫓아버려라. [오슬러]
61. 중요한 건 당신이 어떻게 시작했는가가

아니라 어떻게 끝내는가 이다.

[앤드류 매튜스]
62. 독수리는 마지막 성공을 거둘 때까지

온 생명을 바쳐 노력한다. [여안교]
63. 어쨌든 노력을 계속 하시오.

그렇게 하는 가운데 언젠가는 반드시 자신과
...
[알렉산더 듀마]
90. 네가 가지고 있는 최선의 것을 세상에 주라.

그러면 최선의 것이 돌아오리라.[M.A. 베레]
91. 오늘을 붙들어라!
...
날이다.[에머슨]
92. 얇은 얼음에서 스케이트를 탈 때

우리의 안전은 속도에 있다.[애머슨]
93. 자신이 의식하고 있는 겸손은

죽어 있는 것이다. [에센바흐]
94. 인간이란 미소와 눈물 사이를 왕래하는

시계추와 같은 것이다. [바이런]
95. 남을 따르는 법을 알지 못하는 사람은
...
모두 초월한다. [쉴러]
98. 가난은 많은 뿌리를 갖고 있습니다.

그러나 큰 뿌리는 무식입니다. [존슨]
99. 일을 쫓아라.

일에 쫓기지 말라. [프랭클린]
100. 할 수 있는 한 훌륭한 인생을 만들라.

인생은 짧고 곧 지나간다. [오울디즈]
101. 행동에 부주의하지 말며,말에 혼동되지
...
상속인만이 있을 따름이다.[유태 격언]
126. 가장 오래 산 사람은 나이가 많은

사람이 아니고 많은 경험을 한 사람이다.
...
사랑하는 것이 행복이다. [헤르만 헤세]
129. 그대로 인하여 세계를 잃는 일이 있어도

세계를 위하여 그대를 잃고 싶지 않다.

[바이런]
130. 인간은 생각하는 것이 적으면

그만큼 더 떠든다. [몽테스키]
131. 많이 팔려면 먼저 많이 사 보라.

[문용은]
132. 몸가짐은 각자가 자기의 모습을

비치는 거울이다. [괴테]
133. 가장 곤란한 것은 모든 사람이
...
[프리드리히 니체]
261. 내가 부자인 것은 소유한 것이 많기

때문이 아니라,

원하는 것이 없기 때문이다. [J. 브라서튼]
262. 날마다 하던 방식대로 하고 있다면

그건 확실히 잘못된 것이다.[찰스 케터링]
263. 인생은 실수를 저지르고

실수를 고쳐나가는 과정이다. [요나스 서크]
264. 성공한 사람이 되기보다는

가치 있는 사람이 되도록 하라.

[알베르트 아인슈타인]
265. 가정은 사람을 만드는 공장이다.
...
성공할 확률이 적다. [실러]
290. 성공은 세 번 실망한 후에 찾아온다.

[코르넬리아 토프]

291. 무엇보다도 너 자신에게 진실하라!
...
[아리스토텔레스]
313. 폭력은 무능한 자의 마지막 위안이다.

[아이작 아시모프]
314. 상상력은 우리가 날릴 수 있는

가장 높은 연입니다.[로렌 바콜]
315. 지식은 힘이라기보다는 그 이상이다.
...
[N. 부알로]
317. 아무리 위대한 천재의 능력일지라도

기회가 없으면 소용이 없다.

[나폴레옹]
318. 무엇보다도 너 자신에게 진실하라!
...
자기 운명을 창조해 간다.[세르반테스]
321. 사랑은 그 종류가 하나 밖에 없다.

그러나 사랑을 표현하는 방법은

수만 가지가 넘는다. [그라시안]
322. 꿈을 품어라. 꿈이 없는 사람은
...
아무 것도 얻을 수 없다. [마이크 머독]
325. 무엇인가 하고 싶은 사람은 방법을
...
가득 채워라. [랭]
367. 가장 행복한 삶은 가장 재미있는

생각을 하는 삶이다. [드와이트]
368. 우리는 영혼을 움직이는 침묵이
...
괴로운 것은 없다. [토마스 칼라일]
372. 불가능은 소심한 자의 환상이요

비겁한 사람의 도피처이다.

[나폴레옹]
373. 가르친다는 것은 곧 두 번 이상을
...
되어야 한다. [코르뷔제]
377. 가정이란 어떠한 형태의 것이든

인생의 커다란 목표이다.

[J.G. 홀랜드]
378. 행복이란 우리 자신의 가정에서 자라며,

남의 집 정원에서 뽑아지는 것이 아니다.

[D.W. 제럴드]
379. 감정을 잘 다스렸을 때 비로소

소박한 마음이 생겨나는 법이다.

[달랑베르]
380 . 수가 많다고 강한 것은 아니다.
...
영혼과 관계가 있다. [톨스토이]
393. 굶주린 사람에게 배고픔의 고통을

참아야 한다는 충고를 대식가(大食家)가

어찌 진지하게 얘기할 수 있겠는가?

[칼릴 지브란]
394. 거지의 사랑을 받게 된 사람이야말로

군주중의 군주이다. [칼릴 지브란]
395.  감히 도전해 보지 못한 사람들은

아무 것도 하지 못한다.[지그 지글라]

396. 가르치는 것은 두 번 배우는 것이다.

[주베르]

397. 아마추어는 남을 상대로 싸우지만
...
[앨버트 아인슈타인]
399. 재능은 한계가 있지만, 노력엔 한계가 없다!

[앨버트 아인슈타인]
400. 좋은 항아리가 있으면 아낌없이 사용하라.

내일이면 깨질지도 모른다! [탈무드]
401. 침대 속에서는 아무리 생각해 본다고 해도

별로 신통한 생각을 얻을 수 없다[F. 카프카]
402. 부자의 큰 행복은

자선을 할 수 있다는 것에 있다.[라 브뤼에르]
...
불행에 대한 진정한 동정심을 갖지 못한다.

[앙드레지드]
405. 밝은 성격은 어떤 재산보다도 귀하다.
...
제일 많은 시간을 가진다.
409. 어리석은 사람은 자기 혓바닥을

억제하지 못한다. [초서]
410. 시간이 모든 것을 말해준다.

시간은 묻지 않았는 데도 말을 해주는
...
제일 조건이다. [마미엘]
414. 공포로 인해 타협하지 말 것이며

남이 나에게 타협하는 것을

두려워하지도 말라. [케네디]
415. 오늘 할 수 있는 일에 전력을 다하라.

그러면 내일에는 한걸음 더 진보한다.

[뉴턴]

416. 만약 제군이 돈의 가치를 알고 싶으면

나가서 얼마간의 돈을 빌려 보라.[프랭클린]
417. 오늘이라는 날은 두 번 다시

오지 않는다는 것을 잊지 말라.[단테]
418. 안심하면서 먹는 한 조각 빵이

근심하면서 먹는 잔치보다 낫다.[이솝]
419. 열의 없이 성취된 위업이란

아직 하나도 없다. [애머슨]
420. 물고기를 주어라. 한 끼를 먹을 것이다.

물고기 잡는 법을 가르쳐 주어라.

평생을 먹을 것이다. [탈무드]
421. 햇빛은 하나의 초점에 모아질 때만

불꽃을 피우는 법이다. [벨]
422. 속이는 말로 재물을 모으는 것은
...
이룰 수 있겠는가? [원효]
425. 살아가는 기술이란 하나의 공격 목표를 골라

그리로 힘을 집중시키는 일이다.

[앙드레 모로아]

426. 사랑이란 늙는다는 것을 모른다.
...
그리고 살아 있는 현재에 행동해라.[롱펠로우]
434. 배가 항구에 있어 가장 안전하지만

그것이 배의 존재이유는 아니다.[괴테]
435. 성공은 결과이지 목적은 아니다.[플로베르]
436. 괴로움을 견디려면 죽는 것보다

더 큰 용기가 필요하다. [나폴레옹]
437. 친구를 갖는다는 것은

또 하나의 인생을 갖는 것이다. [그라시안]
438. 험한 언덕을 오르기 위해서 처음에는

천천히 걷는 것이 필요하다.[세익스피어]
439. 현명한 자는 적으로 부터

많은 것을 배운다. [아리스토파네스]
440 . 일곱 번의 70배까지 용서하라.
...
내 습관으로 만든다! [빌 게이츠]
445. 무엇보다도 너 자신에게 진실하라!

[셰익스피어]
446. 열매를 맺지 않는 꽃은 심지 말고

의리 없는 벗은 사귀지 말라.[명심보감]
447. 신은 행동하지 않는 자를 결코

돕지 않는다.[소포클레스]
448. 무지할수록 독단적이다.

[윌리엄 오슬러]
449 . 가장 소름끼치는 불신은 바로 자기

안에 있는 불신이다.[토마스 카라일]
450. 회복의 유일한 길은

다시 시작하는 것이다. [체이즈]
451. 목표가 미래의 당신을 결정해 준다.

[줄리어스 어빙]
452. 바쁘다는 것만으로는 충분치 않다.
...
약한 자의 모습이다. [에릭 호퍼]
454. 꿈이 없다면 아무일도 일어나지 않는다.

[칼 샌드버그]
455. 아는 자는 말하지 않는다.

말하는 자는 알지 못한다. [노자]
456. 인생을 발전시키는 것은 그가 하고 있는

일이 아니라 그가 하고자 하는 일이다.

[로버트 브라우닝]
457. 일의 성패는 능력보다 신념에 달려 있다.

[클라우드 M. 브리스톨]
458. 강인한 의지 없이는 뛰어난 재능도 없다.

[효뇨레 드 발자크]
459. 일의 성패는 능력보다 신념에 달려 있다.

[클라우드 M. 브리스톨]
460 . 사람은 자기가 한 약속을 지킬만한

좋은 기억력을 가져야 한다. [니체]
461. 중요한 건 당신이 어떻게 시작했는가가
...
최선이 나를 고른다.[타고르]
463. 믿는다는 것은 이 세상에서 제일 큰 힘이다.

내가 그것을 말할 때, 어떤 사람도

비웃지 못하도록 하라.[디오도어 루빈]
464. 명성을 구하여 달리는 자는, 명성에
...
사람에게만 미소를 짓는다.[파스퇴르]
472. 요구받기 전에 먼저 충고하지 말라.

[에라스무스]
473. 커다란 비결은 결코 낡지 않은

인간으로서 인생을 끝까지 사는 것이다.

[시바이쩌]
474. 처음 시작은 가장 용기 있는 자 만이

할 수 있다. [노르웨이 속담]
475. 계단을 밟아야 계단 위에 올라설 수 있다.

[터키속담]
476. 큰 부자에게는 아들은 없다.

다만 상속인만이 있을 따름이다.[유태 격언]
477. 내가 성공한 것은, 어느 때이건 반드시
...
480. 그대로 인하여 세계를 잃는 일이 있어도

세계를 위하여 그대를 잃고 싶지 않다. [바이런]
481. 돈은 거름과 같아서

뿌리지 않으면 썩기 쉽다.[베이컨]
482. 대문자만으로 인쇄된 책은  읽기 힘들다.

일요일밖에 없는 인생도

그것과 마찬가지이다. [장 파울]
483. 칭찬받기를 원하면 자화자찬을 하지 말라.
...
# 엑셀 파일 저장
workbook.save(r'C:\Users\GJAISCHOOL\Desktop\X_filter\Algorithm\dataset\example.xlsx')
